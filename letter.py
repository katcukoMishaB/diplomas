...
class Ui_LetterWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Генератор и благодарственных писем"))
        self.pushButton.setText(_translate("MainWindow", "Выбрать шаблон \n благодарственного письма"))
        self.label.setText(_translate("MainWindow", "Генерация и Отправка благодарственных писем"))
        self.pushButton_2.setText(_translate("MainWindow", "Выбрать данные"))
        self.pushButton_3.setText(_translate("MainWindow", "Генерация \n благодарственного письма"))
        self.pushButton_4.setText(_translate("MainWindow", "Отправка \n благодарственного письма"))
